...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataDir", type=str, default="/ccx_results/simulations_sphere_15/sphere_15/")
    parser.add_argument("--simDir", type=str, default="/ccx_results/simulations_sphere_15/")
